...
const AutoVoucherPaymentCash1 = () => {
    ...
    const save = () => { if (editId) updateRecord('autoVoucherPaymentCash1', editId, form); else addRecord('autoVoucherPaymentCash1', form); close(); };

    return (
        <div className="p-6">
            <PageHeader title="Auto Voucher — Payment Cash" description="Automated cash payment voucher entries" icon={Wallet} />
            <DataTable columns={columns} data={state.autoVoucherPaymentCash1 || []} onAdd={openAdd} addLabel="New Entry" onEdit={openEdit} onDelete={(r) => deleteRecord('autoVoucherPaymentCash1', r.id)} />
                ...
                <div className="p-6 space-y-6">
                    ...
                    <FormContainer title="Name & Type" icon={Settings}>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <FormField label="Ref Voucher No" id="REF_VOUNO" value={form.REF_VOUNO} onChange={(e) => set('REF_VOUNO', e.target.value)} required />
                        </div>
                    </FormContainer>
...
export default AutoVoucherPaymentCash1;
