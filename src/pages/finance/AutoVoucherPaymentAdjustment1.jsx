...
import { RefreshCw, Database, Calendar, Settings } from 'lucide-react';
...
const AutoVoucherPaymentAdjustment1 = () => {
    ...
    const save = () => { if (editId) updateRecord('autoVoucherPaymentAdj1', editId, form); else addRecord('autoVoucherPaymentAdj1', form); close(); };

    return (
        <div className="p-6">
            <PageHeader title="Auto Voucher — Payment Adjustment" description="Automated payment adjustment voucher entries" icon={RefreshCw} />
            <DataTable columns={columns} data={state.autoVoucherPaymentAdj1 || []} onAdd={openAdd} addLabel="New Entry" onEdit={openEdit} onDelete={(r) => deleteRecord('autoVoucherPaymentAdj1', r.id)} />
...
export default AutoVoucherPaymentAdjustment1;
