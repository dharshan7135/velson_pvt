...
const AutoVoucherReceiptAdjustment1 = () => {
    ...
    const save = () => { if (editId) updateRecord('autoVoucherReceiptAdj1', editId, form); else addRecord('autoVoucherReceiptAdj1', form); close(); };

    return (
        <div className="p-6">
            <PageHeader title="Auto Voucher — Receipt Adjustment" description="Automated receipt adjustment voucher entries" icon={RefreshCw} />
            <DataTable columns={columns} data={state.autoVoucherReceiptAdj1 || []} onAdd={openAdd} addLabel="New Entry" onEdit={openEdit} onDelete={(r) => deleteRecord('autoVoucherReceiptAdj1', r.id)} />
...
export default AutoVoucherReceiptAdjustment1;
