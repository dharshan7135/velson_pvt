            ...
            <FormModal isOpen={modal} onClose={close} title={editId ? 'Edit Process' : 'Add Process'} size="lg">
                <div className="p-6 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                        ...
                        <FormField label="Process Name" id="processName" required value={form.processName} onChange={(e) => set('processName', e.target.value)} error={errors.processName} />
                        ...
                        <FormField label="Idle Time" id="idleTime" type="number" value={form.idleTime} onChange={(e) => set('idleTime', e.target.value)} />
                    </div>
                    {/* Image Upload */}
