...
import { ArrowRightLeft, Database, ShoppingBag, DollarSign, Percent, Calculator, Info } from 'lucide-react';
...
const SalesTran = () => {
    ...
    const save = () => { if (editId) updateRecord('salesTrans', editId, form); else addRecord('salesTrans', form); close(); };

    return (
        <div className="p-6">
            <PageHeader title="Sales Transaction" description="Line-level sales transactions with item, tax, and barcode tracking" icon={ArrowRightLeft} />
            <DataTable columns={columns} data={state.salesTrans || []} onAdd={openAdd} addLabel="Add Sales Line" onEdit={openEdit} onDelete={(r) => deleteRecord('salesTrans', r.id)} />
            <FormModal isOpen={modal} onClose={close} title={editId ? 'Edit Sales Line' : 'New Sales Line'} size="full">
                <div className="p-6 space-y-6">
                    ...
                    <FormContainer title="Tax Breakdown">
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <FormContainer title="System & Audit" icon={Info}>
